package com.Bootcamp_HomePage_part1_Medium3;
...
public class TNHomePageTest {
	...
	public void openHomepage() {
		...
		homepage = new HomePageOfTN(driver);
	}
	@Test(priority = 1)
	...
	public void searchAction() {
		homepage.searchbox().get("Monitor");
		homepage.search_Button().switchTo();
